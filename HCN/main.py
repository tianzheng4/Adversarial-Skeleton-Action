...
def train_and_evaluate(model, train_dataloader, val_dataloader, optimizer,
    ...
    for epoch in range(params.start_epoch,params.num_epochs):
        ...
        train_metrics = train(model, optimizer, loss_fn, train_dataloader, metrics, params,logger, add_noise=add_noise, noise_sigma=noise_sigma)

        # Evaluate for one epoch on validation set
        val_metrics = evaluate(model, loss_fn, val_dataloader, metrics, params,logger, add_noise=add_noise, noise_sigma=noise_sigma)
